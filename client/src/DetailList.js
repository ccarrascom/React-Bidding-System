			...
			<div className="col-md-6">
				<div className="bid-detail-div card">
					...
					<div className="card-body">
						...
						{this.props.timeFromServer < 0 &&
							<div className="badge badge-success">VENDIDO</div>
						}
						{this.props.userName !== '' &&
							<div>
								{this.state.showBidInput ? (
									<form className="form-inline bid-form" onSubmit={this.handleSubmit}>
										...
										<input type="button" className="btn btn-primary rebid-input" value="Hacer otra oferta" onClick={this.reBid.bind(this)} />
									)
								}
					...
					{Object.keys(this.props.bidHistory).length > 0 &&
						<div className="card-footer bid-history-div">
							<h6 className="bid-history-header ">Historial</h6>
